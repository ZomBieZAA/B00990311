import{a1 as e}from"./index-a0afce76.js";const t="prePassDeclaration",a=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStoreWGSL[v]=h;const p="imageProcessingDeclaration",c=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[p]=c;const u="imageProcessingFunctions",m=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[u]=m;const S="bumpFragmentMainFunctions",g=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[S]=g;const w="bumpFragmentFunctions",x=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[w]=x;const T="clipPlaneFragmentDeclaration",X=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[T]=X;const D="fogFragmentDeclaration",L=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[D]=L;const C="clipPlaneFragment",I=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStoreWGSL[C]=I;const P="bumpFragment",E=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[P]=E;const y="decalFragment",A=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[y]=A;const M="depthPrePass",F=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[M]=F;const O="lightFragment",_=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[O]=_;const N="logDepthFragment",b=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[N]=b;const z="fogFragment",R=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[z]=R;const W="oitFragment",U=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[W]=U;
